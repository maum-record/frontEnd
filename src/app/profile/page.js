...
import { IoIosArrowBack } from "react-icons/io"; // react-icons에서 IoIosArrowBack 아이콘을 가져옵니다.
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-blue-100 to-purple-200 flex flex-col items-center justify-center px-4 py-10">
      <div className="bg-white shadow-lg rounded-2xl p-8 w-full max-w-md">
        ...
        <button
          onClick={() => router.back()}
          className="absolute top-4 left-4 p-2 text-gray-600 hover:text-blue-500"
        >
          <IoIosArrowBack className="text-3xl text-gray-700" /> {/* IoIosArrowBack 아이콘 사용 */}
        </button>
